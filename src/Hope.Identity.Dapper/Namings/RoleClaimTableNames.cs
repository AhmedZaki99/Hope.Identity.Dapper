...
/// </summary>
/// <param name="namingPolicy">The naming policy to use for converting the <see cref="IdentityRoleClaim{TKey}"/> property names to default column names.</param>
...
/// </remarks>
public class RoleClaimTableNames<TKey>(JsonNamingPolicy namingPolicy, string? table = null)
