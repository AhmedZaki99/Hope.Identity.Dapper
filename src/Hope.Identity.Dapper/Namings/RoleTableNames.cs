...
/// The naming policy to use for converting the <see cref="IdentityRole{TKey}"/> property names to default column names (<see langword="null"/> for no conversion).
/// </param>
...
/// </remarks>
public class RoleTableNames<TKey>(JsonNamingPolicy? namingPolicy = null, string? table = null)
