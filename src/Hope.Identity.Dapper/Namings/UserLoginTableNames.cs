...
/// </summary>
/// <param name="namingPolicy">The naming policy to use for converting the <see cref="IdentityUserLogin{TKey}"/> property names to default column names.</param>
...
/// </remarks>
public class UserLoginTableNames<TKey>(JsonNamingPolicy namingPolicy, string? table = null)
